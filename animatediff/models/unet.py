...
from diffusers.models.modeling_utils import ModelMixin # HERE : diffusers new version에 맞춰서 수정
...
class UNet3DConditionModel_modify(ModelMixin, ConfigMixin):
    _supports_gradient_checkpointing = True
